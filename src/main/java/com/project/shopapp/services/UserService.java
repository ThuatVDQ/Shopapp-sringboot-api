...
public class UserService implements IUserService {
    ...
    public User createUser(UserDTO userDTO) throws Exception {
        ...
        Role role = roleRepository.findById(
                userDTO.getRoleId()).orElseThrow(() -> new Exception(localizationUtils.getLocalizedMessage(MessageKeys.ROLE_DOES_NOT_EXISTS)));
    ...
    public String login(
        ...
        //return optionalUser.get();//mu?n tr? JWT token ?
